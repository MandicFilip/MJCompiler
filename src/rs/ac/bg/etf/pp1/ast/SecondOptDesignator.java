...
public class SecondOptDesignator implements SyntaxNode {

    private SyntaxNode parent;
    private int line;
    private OptDesignatorStatement OptDesignatorStatement;

    public SecondOptDesignator (OptDesignatorStatement OptDesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SecondOptDesignator(\n");
